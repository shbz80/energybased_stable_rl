...
def sample_params(mean_state_dict, std_dict, policy):
...
def cem_init_std(state_dict, std_dict, init_std, init_log_std, policy):
...
def cem_stat_compute(best_params, curr_mean, curr_std, policy):
